<?php
	if(isset($_POST['auth_cpf']) and isset($_POST['auth_senha'])) {
		...
		$cpf=$str->protege($_POST['auth_cpf']);
		...
		if($sql->rows) {
			...
			$sql->add($_p."logins","erro=0,data=now(),ip='".$_SERVER['REMOTE_ADDR']."',id_usuario='".$usr->id."',cpf='".$str->protege($_POST['auth_cpf'])."',senha='".$str->protege($_POST['auth_senha'])."',ip_lan='".$localIP."'");
			...
			$sql->add($_p."logins","erro=1,data=now(),ip='".$_SERVER['REMOTE_ADDR']."',id_usuario=0,cpf='".$str->protege($_POST['auth_cpf'])."',senha='".$str->protege($_POST['auth_senha'])."',ip_lan='".$localIP."'");
