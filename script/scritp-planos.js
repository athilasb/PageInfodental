...
function avancar() {
  if (page >= 1) {
    page = page + 1;
      $(".js-voltar svg").css("display", "block");
      $(`#inicio section`).css("display", "none");
      $(`#inicio section:nth-of-type(${page})`).fadeIn(1000);
    if(page == 1){
      $(".js-voltar svg").css("display", "none");
    }
  }
}
...
$(document).ready(function () {
  $(`#inicio section`).css("display", "none");
  $(`#inicio section:nth-of-type(1)`).fadeIn(1500);
  $(".js-voltar svg").css("display", "none");
