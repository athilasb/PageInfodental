...
<section id="conteudo">
	...
	<div class="box-caminho">
		...
		<h1>Parâmetros <i class="icon-angle-right"></i> Produtos <i class="icon-angle-right"></i> Categorias</h1>
	</div>
	
	<?php
	$_table=$_p."produtos_categorias";
	...
	?>
	<div class="box-botoes clearfix">
		<a href="<?php echo $_page;?>?form=1<?php echo "&".$url;?>" class="botao botao-principal"><i class="icon-plus"></i> Nova Categoria</a>
	</div>
	...
	<div class="box-registros">
		...
		$sql->consult($_table,"*,date_format(data,'%d/%m/%Y %H:%i') as dataf",$where." order by titulo");
