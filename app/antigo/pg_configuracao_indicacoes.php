...
<section class="content">
	...
	<section class="grid">
		<form method="post" class="box form formulario-validacao"  autocomplete="off" enctype="multipart/form-data">
			...
			<fieldset>
				<legend><span class="badge">1</span> Indicação</legend>
	...
	<section class="grid">
		<div class="box">
			...
			<div class="filter">
				<div class="filter-button">
					<a href="<?php echo $_page."?form=1&$url";?>" class="verde"><i class="iconify" data-icon="bx-bx-plus"></i><span> Nova Indicação</span></a>
				</div>
			</div>
			...
			<div class="reg">
				...
				while($x=mysqli_fetch_object($sql->mysqry)) {
				?>
				<a href="pg_configuracao_indicacoes.php?form=1&edita=<?php echo $x->id;?>" class="reg-group">
