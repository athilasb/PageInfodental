...
<section class="content">
	...
	<section class="grid">
		<div class="box">
			<form method="post" class="form formulario-validacao"  autocomplete="off" enctype="multipart/form-data">
				...
				<fieldset>
					<legend><span class="badge">1</span> Dados do Profissional</legend>
				...
				<fieldset>
					<legend><span class="badge">4</span> Comissionamento Geral</legend>
				...
				<fieldset>
					<legend><span class="badge">5</span> Comissionamento Personalizado</legend>
				...
				<fieldset>
					<legend><span class="badge">6</span> <?php echo utf8_encode($u->titulo);?></legend>
	...
	<section class="grid">
		<div class="box">
			...
			<div class="filter">
				<div class="filter-button">
					<a href="<?php echo $_page."?form=1&$url";?>" class="verde"><i class="iconify" data-icon="bx-bx-plus"></i><span> Novo Cirurgião</span></a>
				</div>
			</div>
			...
			<div class="reg">
				...
				while($x=mysqli_fetch_object($sql->mysqry)) {
				?>
				<a href="pg_configuracao_profissionais.php?form=1&edita=<?php echo $x->id;?>" class="reg-group">
					...
					<div class="reg-data" style="flex:0 1 100px;">
						<p><?php echo empty($x->celular)?"-":$x->celular;?></p>
					</div>
					<div class="reg-data" style="flex:0 1 100px;">
						<p>
							<?php
