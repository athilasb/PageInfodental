		...
		<form method="post" class="form formulario-validacao"  autocomplete="off" enctype="multipart/form-data">
			...
			<section class="grid" style="padding:1rem;">
				<div class="box">
					...
					<div class="filter">
						...
						<div class="filter-group">
							<div class="filter-title">
								<span class="badge">8</span> Preencha as informações da Clínica
							</div>
						</div>
					...
					<div class="colunas4">
						<dl class="dl2">
							<dt>Whatsapp <span class="iconify" data-icon="bi:info-circle-fill" data-inline="true" style="color: #98928E;"></span></dt>
							<dd>
								<input type="text" name="whatsapp" value="<?php echo $values['whatsapp'];?>"  class="obg noupper celular" />
							</dd>
						</dl>
						<dl class="dl2">
							<dt>Endereço <span class="iconify" data-icon="bi:info-circle-fill" data-inline="true" style="color: #98928E;"></span></dt>
							<dd>
					...
					<div class="colunas4">
						<dl class="dl2">
							<dt>Facebook <span class="iconify" data-icon="bi:info-circle-fill" data-inline="true" style="color: #98928E;"></span></dt>
							<dd>
								<input type="text" name="facebook" value="<?php echo $values['facebook'];?>"  class="noupper" />
							</dd>
						</dl>
						<dl class="dl2">
							<dt>Instagram <span class="iconify" data-icon="bi:info-circle-fill" data-inline="true" style="color: #98928E;"></span></dt>
							<dd>
					...
					<dl>
						<dt>Texto Institucional <span class="iconify" data-icon="bi:info-circle-fill" data-inline="true" style="color: #98928E;"></span></dt>
