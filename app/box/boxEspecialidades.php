<?php
	...
	$_table=$_p."parametros_especialidades";
	$_urlAjax="box/boxEspecialidades.php";
	$_title="Especialidades";
	...
	if(isset($_POST['ajax'])) {
		...
		if($_POST['ajax']=="listar") {
			...
			$vSQL="";
			foreach($campos as $v) {
				if(isset($_POST[$v])) $vSQL.="$v='".addslashes(utf8_decode(strtoupperWLIB($_POST[$v])))."',";
			}
...
<section class="modal" style="width:700px;">
	...
	<header class="modal-header">
		<div class="filtros">
			<h1 class="filtros__titulo">Especialidades</h1>
		</div>
	</header>
