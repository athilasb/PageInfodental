<?php
	...
	class Adm {
		...
		private 
			...
			$datas=array('data_nascimento','data_modelo','data_noticia','data_versao','data_reg','data_catalogo','vencimento','efetivado_data','responsavel_datanascimento','data_vencimento','data_emissao');
		...
		function url($get) {
			...
			$noURL=explode(",","fichadocliente,edita,pagina,ancoraanexo,csv,deleta,form,pagina,alterarUnidade,deletaPaciente,unirPagamentos,abrirAnamnese");
