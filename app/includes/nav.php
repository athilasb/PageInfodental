	...
	$_menu = array(/*'dashboard'=>array('page'=>'tarefas-inteligentes.php',
		...
		'analytics' => array(
			'page' => 'pg_inteligencia_analytics.php',
		...
		'landingpage' => array(
			'page' => 'pg_landingpage.php',
			'pages' => explode(",", "pg_landingpage.php,pg_landingpage_configuracao.php"),
			'title' => 'Landing Page',
			'icon' => '<i class="iconify" data-icon="fluent:web-asset-20-regular"></i>'
		),
		'whatsapp' => array(
		...
		'configuracoes' => array(
			'page' => 'pg_configuracoes_clinica_colaboradores.php',
