<?php
	...
	# ASIDE PAGAMENTO AVULSO CONTAS A RECEBER

		if (isset($apiConfig['avulsoAReceber'])){
			?>
							...
							<form class="form" action="">
										...
										<dl data-select2-id="select2-data-6-t6vw">
											<dd data-select2-id="select2-data-5-bdxs">
												<select name="id_beneficiario"
													class="select2 obg-0 ajax-id_paciente select2-hidden-accessible"
													data-select2-id="select2-data-1-ld9e" tabindex="-1" aria-hidden="true">
													<option value="" data-select2-id="select2-data-3-256t">Buscar Beneficiario...
													</option>
												</select><span
													class="select2 select2-container select2-container--default select2-container--below"
													dir="ltr" data-select2-id="select2-data-2-n7js" style="width: 100px;"><span
														class="selection"><span class="select2-selection select2-selection--single"
															role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0"
															aria-disabled="false"
															aria-labelledby="select2-id_beneficiario-8s-container"
															aria-controls="select2-id_beneficiario-8s-container"><span
																class="select2-selection__rendered"
																id="select2-id_beneficiario-8s-container" role="textbox"
																aria-readonly="true" title="Buscar Beneficiario...">Buscar
																Beneficiario...</span><span class="select2-selection__arrow"
																role="presentation"><b
								...
								<div>
									<dl>
										...
										<textarea style="padding: 10px;" class="js-valor" name="descrição" id="" cols="30"
											rows="10"></textarea>
										</dd>
									</dl>
								</div>
								...
								<dl style="margin-top:1.5rem;">
									<dd><button href="javascript:;" class="button button_main" type="button" data-loading="0"><i
												class="iconify"
												data-icon="fluent:add-circle-24-regular"></i><span>Adicionar</span></button></dd>
								</dl>
							</form>
						</fieldset>
					</div>
	...
	#Pagamento		
					...
					<div class="aside__inner1">
						...
						<form method="post" class="aside-content form">
							...
							<section class="tab tab_alt js-tab">
								...
								<a href="javascript:;" onclick="$('.js-fin').hide(); $('.js-fin-programacao').show();"
									class="active">Programação de Pagamento</a>
								<a href="javascript:;" onclick="$('.js-fin').hide(); $('.js-fin-agrupamento').show();"
									class="js-tab-agrupamento">Agrupamento</a>
							</section>
							...
							<div class="js-fin js-fin-programacao">
								...
								<fieldset class="js-fieldset-pagamentos">
									...
									<dl>
										<dd>
											<label><input type="radio" name="tipoBaixa" value="pagamento" checked
													onclick="$('.js-pagamento').show(); $('.js-desconto').hide()"> Pagamento</label>
											<label><input type="radio" name="tipoBaixa" value="desconto"
													onclick="$('.js-pagamento').hide(); $('.js-desconto').show();"> Desconto</label>
										</dd>
									</dl>
									<section class="js-pagamento">
										<div class="colunas4">
											...
											<dl>
												<dt>Vencimento</dt>
												<dd><input type="text" class="js-vencimento js-tipoPagamento data"
														value="<?= date('d/m/Y'); ?>" /></dd>
											</dl>
											<dl>
												<dt>Obs.:</dt>
										...
										<dl>
											<dd><label><input type="checkbox" name="juros" class="input-switch  js-aplicar-multas-juros"
														onclick="//$('.js-multa').toggle();" checked />Aplicar juros e multas</label>
											</dd>
										</dl>
										<div class="js-multa" style="display:none;">
											<div class="colunas4">
												...
												<dl>
													...
													<dd class="form-comp"><span>R$</span><input type="text"
															class="js-descontoMultasJuros money" style="width:100px;" value="0,00" />
													</dd>
												</dl>
												<dl style="font-weight:bold">
													<dt>Total</dt>
									...
									<section class="js-desconto" style="display:none">
										<div class="colunas4">
											<dl>
												<dt>Valor</dt>
												<dd class="form-comp"><span>R$</span><input type="text"
														class="js-valorDesconto money" /></dd>
											</dl>
											<dl class="dl3">
												<dt>Observações</dt>
									...
									<dl style="margin-top:1.5rem;">
										<dd><button href="javascript:;" class="button button_main js-btn-addBaixa" type="button"
												data-loading="0"><i class="iconify"
													data-icon="fluent:add-circle-24-regular"></i><span>Adicionar</span></button></dd>
									</dl>
								</fieldset>
								<fieldset>
								...
								<section class="filter">
									...
									<div class="filter-group">
										<div class="filter-form form">
											...
											<dl>
												<dd><button type="button" class="button button_main js-btn-receber" data-loading="0"><i
															class="iconify" data-icon="fluent:checkmark-12-filled"></i>
														<span>Receber</span></button></dd>
											</dl>
										</div>
									</div>
								</section>
							...
							success: function(rtn) {
								if (rtn.success) {
									...
									$('#js-aside-asFinanceiro .js-dataOriginal').html(
										`${`${dados.data_vencimento.split('-')[2]}/${dados.data_vencimento.split('-')[1]}/${dados.data_vencimento.split('-')[0]}`}`
										);
									$('#js-aside-asFinanceiro .js-valorParcela').html(
										`R$ ${number_format(dados.valor, 2, ",", ".")}`);
									$('#js-aside-asFinanceiro .js-valorDesconto').html(
										`R$ ${number_format(dados.valor_desconto, 2, ",", ".")}`);
									$('#js-aside-asFinanceiro .js-valorCorrigido').html(
										`R$ ${number_format((dados.valor-dados.valor_desconto), 2, ",", ".")}`);
									$('#js-aside-asFinanceiro .js-saldoPagar').html(
										`R$ ${number_format((dados.saldoApagar), 2, ",", ".")}`);
				...
				const pagamentosAtualizaCampos = (formaDePagamento) => {
					if (formaDePagamento) {
						...
						$(obj).find(
							'.js-identificador,.js-parcelas,.js-creditoBandeira,.js-debitoBandeira,.js-debitoBandeira,.js-valorCreditoDebito,.js-obs,.js-valorCreditoDebitoTaxa'
							).parent().parent().hide();
						if (tipo == "credito") {
							$(obj).find(
								'.js-parcelas,.js-creditoBandeira,.js-valorCreditoDebito,.js-valorCreditoDebitoTaxa,.js-identificador'
								).parent().parent().show();
						} else if (tipo == "debito") {
							$(obj).find('.js-debitoBandeira,.js-valorCreditoDebito,.js-valorCreditoDebitoTaxa,.js-identificador')
								.parent().parent().show();
							...
							let valorDesconto = (unMoney($('.js-descontoMultasJuros').val()) != undefined) ? unMoney($(
								'.js-descontoMultasJuros').val()) : 0
					...
					if (id_formapagamento.length > 0) {
						...
						if (tipo == 'credito') {
							...
							if (id_operadora !== undefined && parcela !== undefined) {
								...
								let taxa = 0;
								let cobrarTaxa = 0;
								if (_taxasCredito[id_operadora][id_bandeira][parcela]) taxa = _taxasCredito[id_operadora][
									id_bandeira
								][parcela];
							...
							if (rtn.success) {
								...
								if (rtn.baixas.length > 0) {
									...
									rtn.baixas.forEach(x => {
										...
										if (x.tipoBaixa == "PAGAMENTO") {
											if (x.formaDePagamento.length > 0) {
												if (x.id_formapagamento == 2) {
													...
													pagamento =
														`${x.formaDePagamento}<font color=#999><br /></font>`;
												} else {
											...
											pagamento =
												`<span class="iconify" data-icon="il:dialog" data-inline="true" data-height="18"></span> ${x.obs}`;
										}
										...
										if (x.pago == 1) {
											icon =
												`<span class="iconify tooltip" title="pago" data-icon="akar-icons:circle-check" data-inline="true" style="color:green"></span>`;
											btnReceber =
												`<button type="button" class="button button_green" data-id_baixa="${x.id_baixa}" data-index="${contador}" title="Pagar" disabled><span>Recebido</span></button>`
										} else {
											btns =
												`<a href="javascript:;" class="js-estorno button button__sec" data-id_baixa="${x.id_baixa}" title="Estorno"><span class="iconify" data-icon="typcn:arrow-back" data-inline="false"></span></a>`;
											btnEstorno =
												`<a href="javascript:;" class="js-estorno button button__sec" data-id_baixa="${x.id_baixa}" title="Estorno"><i class="iconify" data-icon="fluent:delete-24-regular"></i></span></a>`;
											if (x.tipoBaixa == "PAGAMENTO") {
												btns +=
													` <a href="javascript:;" class="js-receber button button__sec" data-id_baixa="${x.id_baixa}" data-index="${contador}" title="Pagar"><span class="iconify" data-icon="ic:round-attach-money" data-inline="false"></span></a>`;
												btnReceber =
													`<a href="javascript:;" class="js-receber button button__sec" data-id_baixa="${x.id_baixa}" data-index="${contador}" title="Pagar"><i class="iconify" data-icon="fluent:checkmark-24-filled"></i><span>Receber</span></a>`
											}
											if (x.vencido) {
												icon =
													`<span class="iconify tooltip" title="vencido" data-icon="icons8:cancel" data-inline="true" style="color:red"></span>`;
											} else {
												icon =
													`<span class="iconify tooltip" title="em aberto" data-icon="bx:bx-hourglass" data-inline="true" style="color:orange"></span>`;
											}
										}
										...
										if (x.valorMulta > 0) {
											...
											textMulta =
												`<span style="font-size:12px;color:var(--cinza4)">Multa: R$${number_format(x.valorMulta,2,",",".")}</span></br>`
										}
										if (x.valorJuros > 0) {
											ValorParcela += parseFloat(x.valorJuros);
											textJuros =
												`<span style="font-size:12px;color:var(--cinza4)">Juros: R$ ${number_format(x.valorJuros,2,",",".")}</span></br>`
										}
										if (x.descontoMultasJuros > 0) {
											ValorParcela -= parseFloat(x.descontoMultasJuros);
											TextDescontoIncargos =
												`<span style="font-size:12px;color:var(--cinza4)">Descontos: R$ ${number_format(x.descontoMultasJuros,2,",",".")}</span></br>`
										}
										...
										if (x.tipoBaixa == "PAGAMENTO") {
											if (x.formaDePagamento.length > 0) {
												if (x.id_formapagamento == 2) {
													taxaCartao =
														`<span style="font-size:12px;color:var(--cinza4)">Taxa Cartão: R$${number_format(((ValorParcela)*parseFloat(x.taxa)/100),2,",",".")}</span><br>`
												}
											}
										}
									...
									$('#js-aside-asFinanceiro .js-baixas').append(
										'<tr class="js-tr"><td colspan="4"><center>Nenhuma baixa cadastrada</center></td></tr>'
										);
								}
				...
				$(function() {
						...
						if (_pagamentos[pagamentoIndex]) {
							...
							if (pagamento.baixas[baixaIndex]) {
								...
								if (baixa.pago == "0") {
									...
									let data =
										`ajax=baixaEstornarPagamento&id_baixa=${id_baixa}&id_pagamento=${id_parcela}`;
									swal({
										title: "Atenção",
										...
										if (isConfirm) {
											$.ajax({
												...
												success: function(rtn) {
													if (rtn.success) {
														_pagamentos[pagamentoIndex].baixas[
															baixaIndex].pago = "0";
														$('#js-aside-asFinanceiro-receber .aside-close')
															.click();
														$('#js-aside-asFinanceiro .aside-close')
															.click();
														$('.js-pagamento-item-' + id_parcela)
														.click();
														$('[name="alteracao"]').val("1")
					...
					$('#js-aside-asFinanceiro .js-baixas').on('click', '.js-receber', function() {
						...
						if (_pagamentos[pagamentoIndex]) {
							...
							if (pagamento.baixas[baixaIndex]) {
								...
								valorParcela = valorParcela + parseFloat(valorJuros) + parseFloat(valorMulta) +
									parseFloat(descontoMultasJuros)
								...
								$('#js-aside-asFinanceiro-receber .js-valorParcela').val(number_format((valorParcela),
									2, ",", "."));
						...
						if (erro.length > 0) {
							...
							if (_pagamentos[pagamentoIndex].baixas[baixaIndex]) {
								...
								if (obj.attr('data-loading') == 0) {
									...
									let data =
										`ajax=receber&id_baixa=${id_baixa}&dataPagamento=${dataPagamento}&id_banco=${bancoPagamento}`;
					...
					$('#cal-popup').on('click', '.js-btn-pagamento-excluir', function() {
						...
						swal({
							...
							function(isConfirm) {
								if (isConfirm) {
									document.location.href = '?<#?= "id_paciente=$paciente->id&id_pagamento="; ?>' +
										idPagamento;
								} else {
									swal.close();
								}
					...
					$('.js-valor').keyup(function() {
						...
						if (diferenca >= 1) {
							if ($('.js-aplicar-multas-juros').prop('checked') == true) {
								...
								let ValorJuros = (ValorDigitado * (((_clinica[1].politica_juros) / 30) / 100)) * Math
									.floor(diferenca)
					...
					$('.js-descontoMultasJuros').keyup(function() {
						...
						$('.js-TotalaPagar').text(number_format((valorOriginal + ValorJuros + ValorMulta) -
							ValorDigitado, 2, ",", "."))
					})
					...
					$('.js-aplicar-multas-juros').click(function() {
						...
						if (diferenca >= 1) {
							if ($(this).prop('checked') == true) {
								...
								if (ValorDigitado > 0) {
									let ValorMulta = (ValorDigitado * ((_clinica[1].politica_multas) / 100))
									let ValorJuros = (ValorDigitado * (((_clinica[1].politica_juros) / 100))) * Math
										.floor(diferenca)
									$('.js-valorMultas').text(number_format(ValorMulta, 2, ",", "."))
									$('.js-valorJuros').text(number_format(ValorJuros, 2, ",", "."))
					...
					$('.js-btn-addBaixa').click(function() {
						...
						if (loading == 0) {
							...
							if (tipoBaixa == "despesa" || tipoBaixa == "desconto" || tipoPagamento !== undefined) {
								...
								let valor = ($('input.js-valor').val() && $('input.js-valor').val().length > 0 &&
										unMoney($('input.js-valor').val()) > 0) ? unMoney($('input.js-valor').val()) :
									'';
								let valorDesconto = ($('input.js-valorDesconto').val().length > 0 && unMoney($(
									'input.js-valorDesconto').val()) > 0) ? unMoney($('input.js-valorDesconto')
								.val()) : '';
								let valorJuros = ($('.js-valorJuros').text() && $('.js-valorJuros').text().length > 0 &&
										unMoney($('.js-valorJuros').text()) > 0) ? unMoney($('.js-valorJuros').text()) :
									'';
								let valorMulta = ($('.js-valorMultas').text() && $('.js-valorMultas').text().length >
									0 && unMoney($('.js-valorMultas').text()) > 0) ? unMoney($('.js-valorMultas')
									.text()) : '';
								let descontoMultasJuros = ($('input.js-descontoMultasJuros').val() && $(
									'input.js-descontoMultasJuros').val().length > 0 && unMoney($(
									'input.js-descontoMultasJuros').val()) > 0) ? unMoney($(
									'input.js-descontoMultasJuros').val()) : 0;
								...
								if (tipoBaixa == 'pagamento') {
									...
									else if (saldoAPagar < unMoney(valor)) erro =
										`O valor não pode ser maior que <b>${number_format(saldoAPagar,2,",",".")}`;
									if (tipoPagamento == 'credito') {
										...
										else if (creditoBandeira.length == 0) erro =
											'Selecione a <b>Bandeira</b> do Cartão de Crédito';
										else if (creditoParcelas.length == 0) erro =
											'Selecione o <b>Nº de Parcelas</b> do Cartão de Crédito';
										else if (saldoAPagar < unMoney($('input.js-valor').val())) erro =
											`O valor não pode ser maior que <b>${number_format(saldoAPagar,2,",",".")}`;
										id_operadora = $('select.js-creditoBandeira option:selected').attr(
											'data-id_operadora');
										...
										else if (debitoBandeira.length == 0) erro =
											'Selecione a <b>Bandeira</b> do Cartão de Débito';
										else if (saldoAPagar < unMoney($('input.js-valor').val())) erro =
											`O valor não pode ser maior que <b>${number_format(saldoAPagar,2,",",".")}`;
										id_operadora = $('select.js-debitoBandeira option:selected').attr(
											'data-id_operadora');
									...
									if (valorDesconto.length == 0 || valorDesconto == '' || valorDesconto == 0) erro =
										'Defina o <b>Valor</b> Para o Desconto';
									else if (obsDesconto.length == 0 || obsDesconto == '') erro =
										'Digite uma <b>Observação</b>';
									obs = obsDesconto
									valor = valorDesconto
								}
								...
								else if (tipoBaixa == "pagamento" && id_formapagamento.length == 0) erro =
									'Defina a <b>Forma de Pagamento</b>';
								else if (saldoAPagar <= 0) erro = `Não existe mais débitos!`;
								else if (descontoMultasJuros >= (saldoAPagar + valorJuros + valorMulta)) erro =
									`Voce Não Pode dar um Desconto Maior do que o Valor da Parcela!`;
								//valorParcela = (unMoney(valorParcela) + valorJuros + valorMulta) - descontoMultasJuros
								if (erro.length == 0) {
									let data =
										`ajax=pagamentoBaixa&tipoBaixa=${tipoBaixa}&id_pagamento=${id_pagamento}&dataPagamento=${dataPagamento}&dataVencimento=${dataVencimento}&valor=${valor}&id_formapagamento=${id_formapagamento}&debitoBandeira=${debitoBandeira}&creditoBandeira=${creditoBandeira}&creditoParcelas=${creditoParcelas}&obs=${obs}&id_operadora=${id_operadora}&taxa=${taxa}&valorParcela=${(valorParcela)}&valorJuros=${(valorJuros)}&valorMulta=${(valorMulta)}&descontoMultasJuros=${descontoMultasJuros}`;
									$.ajax({
										type: "POST",
										url: baseURLApiAsidePagamentos,
										data: data,
										success: function(rtn) {
											if (rtn.success) {
												let pagamentoIndex = $('#js-aside-asFinanceiro .js-index')
													.val();
												_pagamentos[pagamentoIndex].saldoApagar = unMoney(
													_pagamentos[pagamentoIndex].saldoApagar) - unMoney(
													valor)
												baixasAtualizar();
					...
					$('.js-parcelas').change(function() {
						...
						let id_operadora = $('.js-creditoBandeira option:selected').attr('data-id_operadora')
						let id_bandeira = $('.js-creditoBandeira option:selected').val()
						if (_taxaBandeiras[id_operadora] && _taxaBandeiras[id_operadora][id_bandeira] && _taxaBandeiras[
								id_operadora][id_bandeira][qtdParcelas] && _taxaBandeiras[id_operadora][id_bandeira][
								qtdParcelas
							][qtdParcelas] && _taxaBandeiras[id_operadora][id_bandeira][qtdParcelas][qtdParcelas]
							.taxa) {
							valorTaxa = unMoney(_taxaBandeiras[id_operadora][id_bandeira][qtdParcelas][qtdParcelas]
								.taxa)
						}
						$('.js-valorCreditoDebito').text(`R$ ${number_format(valorParcelas, 2, ",", ".")}`)
						$('.js-valorCreditoDebitoTaxa').text(`${number_format(valorTaxa, 2)}`)
								...
								<fieldset style="padding:.75rem 1.5rem;">
									...
									<div class="colunas5">
										<dl>
											<dt>Data Emissão</dt>
											<dd><input type="text" class="js-vencimento js-tipoPagamento data"
													value="<?= date('d/m/Y'); ?>" name="data_emissao" disabled /></dd>
										</dl>
										<dl>
											<dt>Valor Total</dt>
											<dd class="form-comp"><span>R$</span>
									...
									<div class="colunas5">
										...
										<section class="colunas3" id='split-false-splits-qtd' style='display:none'>
											<dl>
												<dt>Quantidade</dt>
												<dd>
													<label><input class="js-splits-quantidade" type="number" name="parcelas" value="1"
											...
											<dl style="font-size: 11px;">
												<dt></dt>
												<dd>
													<label><input type="radio" name="modo_divisao" value="porcentagem"
															checked>Porcentagem</label>
												</dd>
											</dl>
											<dl style="font-size: 11px;">
												<dt></dt>
												<dd>
													<label><input type="radio" name="modo_divisao" value="valor_absoluto">Valor
														Absoluto</label>
												</dd>
											</dl>
										</section>
									...
									<div class="">
										...
										<div class="row">
											...
											<div class="colunas2" style="display:none" id='area-custo-recorrente'>
												<dl class="form-comp">
													<label>a Cada <span>Dias</span><input type="text" class="input-switch" value="30"
															name="area-custo-recorrente-acada-dia" /></label>
												</dl>
												<dl class="form-comp">
													<label>Por <span>meses</span><input type="text" class="input-switch" value="12"
															name="area-custo-recorrente-meses" /></label>
												</dl>
								...
								<fieldset class="js-fieldset-pagamentos">
											...
											<div class="colunas3">
												<dl>
													...
													<dd class="form-comp"><span><i class="iconify"
															...
															class="data js-vencimento" data-ordem="" value="" name="data_vencimento" />
													</dd>
												</dl>
												<dl>
													<dt>Forma de Pagamento</dt>
									...
									<section class="js-tipo js-tipo-manual">
										<dl>
											<dt>Parcelas</dt>
											<dd>
												<label><input class="js-pagamentos-quantidade" type="number" name="parcelas"
														value="<?= isset($values['parcelas']) ? $values['parcelas'] : '0'; ?>"
														style="width:80px;" /></label>
											</dd>
										</dl>
									</section>
									...
									<dl style="margin-top:1.5rem;">
										<dd><button href="javascript:;" class="button button_main js-btn-addPagamento" type="button"
												data-loading="0"><i class="iconify"
													data-icon="fluent:add-circle-24-regular"></i><span>Adicionar</span></button></dd>
									</dl>
								</fieldset>
				...
				const listarSplits = () => {
					...
					splits.forEach((item) => {
						...
						for (let x in centrodecustos) {
							$('.js-fieldset-pagamentos-splits').find('section').find(`[data-id="${item.id}"]`).find(
								'[name="id_centro_de_custo"]').append(
								`<option value="${x}">${centrodecustos[x].titulo}</option>`)
						}
						for (let x in categorias) {
							$('.js-fieldset-pagamentos-splits').find('section').find(`[data-id="${item.id}"]`).find(
								'[name="id_categoria"]').append(
								`<optgroup data-id-categoria="${x}" label="${categorias[x].titulo}"></optgroup>`)
							for (let sub in categorias[x].subcategorias) {
								$('.js-fieldset-pagamentos-splits').find('section').find(`[data-id="${item.id}"]`).find(
									'[name="id_categoria"]').find(`[data-id-categoria="${x}"]`).append(
									`<option value="${sub}">${categorias[x].subcategorias[sub].titulo}</option>`)
							}
						}
					...
					for (let i = 1; i <= qtdParcelas; i++) {
						...
						if (i == qtdParcelas) {
							if (valorTotalParcelado < valorTotal) {
								valorParcelas = number_format(unMoney(valorParcelas) + (unMoney(valorTotal - valorTotalParcelado)),
									2, ",", ".")
								valorTotalParcelado += (unMoney(valorTotal) - unMoney(valorTotalParcelado))
							} else if (valorTotalParcelado > valorTotal) {
								valorParcelas = number_format(unMoney(valorParcelas) - (unMoney(valorTotalParcelado - valorTotal)),
									2, ",", ".")
					...
					$('.js-btn-addPagamento').click(function() {
						...
						if (split_pagamento.length > 0) {
							...
							if (camposSplits.length <= 0) {
								...
								camposSplits.each(function(index, input) {
									...
									let calcular_como = $(input).find(
										`[name="calcular_como_${index+1}"]:checked`).val()
									splits.push({
										porc_valor,
										id_centro_de_custo,
										id_categoria,
									...
									if (!id_centro_de_custo || id_centro_de_custo <= 0 || id_centro_de_custo ==
										undefined) {
						...
						if (CamposPagamentos.length <= 0) {
							...
							CamposPagamentos.each(function(index, input) {
								...
								data_vencimento = data_vencimento[2] + "-" + data_vencimento[1] + "-" +
									data_vencimento[0];
								let valor = unMoney($(input).find('.js-valor').val())
								let id_formapagamento = $(input).find('.js-id_formapagamento').val()
								valor_total += valor
								if (!id_formapagamento || id_formapagamento <= 0 || id_formapagamento ==
									undefined) {
								...
								if (index + 1 == CamposPagamentos.length) {
									if (valor_total < valor_pagamento) {
										erro =
											`a Soma dos Pagamentos Precisam Ser igual ao Total do Pagamento. <br> R$ ${number_format((valor_pagamento-valor_total),2,",",".")} Faltando`
									} else if (valor_total > valor_pagamento) {
										erro =
											`a Soma dos Pagamentos Precisam Ser igual ao Total do Pagamento. <br> R$ ${number_format((valor_total-valor_pagamento),2,",",".")} Passando`
									}
								}
								item.push({
									data_vencimento,
						...
						let data =
							`ajax=addPagamento&tipo_beneficiario=${tipo_beneficiario}&id_beneficiario=${id_beneficiario}&data_emissao=${data_emissao}&descricao=${descricao}&valor_pagamento=${valor_pagamento}&objeto=${JSON.stringify(objetoPagamento)}`;
						$.ajax({
							type: "POST",
							url: baseURLApiAsidePagamentos,
							data: data,
					...
					$('.js-fieldset-pagamentos-splits').on('keyup', '[name="porcentagem-splits"]', async function() {
						...
						if (modo_divisao == 'porcentagem') {
							...
							allSplits.each((i, item) => {
								...
								let valorPorc = parseFloat($(item).find('[name="porcentagem-splits"]')
								.val())
