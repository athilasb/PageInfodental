		...
		$('.js-btn-addBaixa').click(function() {
			...
			if (loading == 0) {
				...
				if (tipoBaixa == "despesa" || tipoBaixa == "desconto" || tipoPagamento !== undefined) {
					...
					let valorJuros = ($('input.js-valorJuros').val() && $('input.js-valorJuros').val().length > 0 && unMoney($('input.js-valorJuros').val()) > 0) ? unMoney($('input.js-valorJuros').val()) : '';
					let valorMulta = ($('input.js-valorMultas').val() && $('input.js-valorMultas').val().length > 0 && unMoney($('input.js-valorMultas').val()) > 0) ? unMoney($('input.js-valorMultas').val()) : '';
					...
					valorParcela = (unMoney(valor) + valorJuros + valorMulta) - descontoMultasJuros
					if (erro.length == 0) {
			...
			<div class="js-fin js-fin-programacao" style="display: ;">
				...
				<fieldset class="js-fieldset-pagamentos">
					...
					<section class="js-pagamento">
						...
						<dl>
							<dd><label><input type="checkbox" name="juros" class="input-switch  js-aplicar-multas-juros" onclick="$('.js-multa').toggle();" />Aplicar juros e multas</label></dd>
						</dl>
						<div class="js-multa" style="display:none;">
							<div class="colunas4">
								<dl>
									<dt>Multa</dt>
									<dd><label class="js-valorMultas money">R$ 5,34</label></dd>
								</dl>
								<dl>
									<dt>Juros</dt>
									<dd><label class="js-valorJuros money">R$ 0,35</label></dd>
								</dl>
								<dl>
									<dt>Desconto Juros</dt>
									<dd class="form-comp"><span>R$</span><input type="text" class="js-descontoMultasJuros money" style="width:100px;" /></dd>
								</dl>
								<dl style="font-weight:bold">
									<dt>Total</dt>
									<dd><label class="js-TotalaPagar money">R$ 110,69</label></dd>
								</dl>
							</div>
						</div>
					</section>
