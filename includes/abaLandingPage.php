...
<ul class="abas">
	...
	<li><a href="pg_landingpages_aclinica.php?<?php echo "id_landingpage=$landingpage->id";?>" class="main-nav__laboratorio<?php echo basename($_SERVER['PHP_SELF'])=="pg_landingpages_aclinica.php"?" active":"";?>">A Clínica</a></li>
