...
<ul class="abas">
	...
	<li><a href="pg_configuracao_profissionais.php?" class="main-nav__resumo-do-paciente<?php echo basename($_SERVER['PHP_SELF'])=="pg_configuracao_profissionais.php"?" active":"";?>">Cirurgiões Dentistas</a></li>
	...
	<li><a href="pg_configuracao_fornecedores.php?" class="main-nav__resumo-do-paciente<?php echo basename($_SERVER['PHP_SELF'])=="pg_configuracao_fornecedores.php"?" active":"";?>">Fornecedores e Parceiros</a></li>
